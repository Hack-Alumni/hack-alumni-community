...
import { buildMeta } from '@hackcommunity/core/remix';
import { Toast } from '@hackcommunity/ui';
import uiStylesheet from '@hackcommunity/ui/index.css?url';
...
export const meta: MetaFunction = () => {
  return buildMeta({
    description: `Your home for all things Hack.Diversity membership. Manage your profile and more!`,
