...
import { listEventRegistrations } from '@hack-alumni/core/events/registrations';
import { type Student } from '@hack-alumni/types';
import { Modal, ProfilePicture } from '@hack-alumni/ui';
