...
/**
 * Returns high-level hack-alumni contributor statistics.
 *
...
/**
 * Returns the merged pull requests for the hack-alumni repository.
 *
...
async function getMergedPullRequests(): Promise<PullRequest[]> {
  ...
  let uri =
    'https://api.github.com/repos/colorstackorg/hack-alumni/pulls?state=closed&per_page=100';
